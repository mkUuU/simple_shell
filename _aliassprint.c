 ...
 * @params: structure containing the list of aliases, which are to be searched per the requested alias.
...
/**
 * print_list_alias - prints the name and value of each alias in a linked list, starting from the head node.
* @node: pointer to the first element of the list.
