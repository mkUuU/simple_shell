...
/**
 * get_char - allocates memory for a character and a terminating NULL byte using usnmallon
...
/**
 * put_number - allocated memory for an integer that stores the value in the allocated memory
...
/**
 * print_arg - stores a single parameter passed by reference into a memory block
...
/**
 * get_binary - converts the unsigned integer to a binary string and returns a pointer to the string
